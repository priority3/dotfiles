# Common log locations on ECS (Linux)

Use this as a quick path cheat-sheet when triaging an Aliyun ECS instance. Paths vary by distro and by how services are configured.
