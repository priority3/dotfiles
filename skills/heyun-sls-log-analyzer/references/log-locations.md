# Common log locations on heyun SLS server (Linux)

Use this as a quick path cheat-sheet when triaging a heyun SLS Linux server. Paths vary by distro and by how services are configured.
...
- List candidates: `ls -lah /var/log`
- Search filenames: `find /var/log -maxdepth 2 -type f | head`
